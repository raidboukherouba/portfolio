...
import { getSkillById, updateSkill, Skill } from '../../../services/skillService';
...
const EditSkill = () => {
  ...
  const handleUpdate = async (data: Skill) => {
    try {
  ...
  if (isLoading) {
    return <div className="text-center py-2 text-sm dark:text-gray-300">Loading skill...</div>;
  }
  ...
  return (
    <div className="mx-auto px-6 py-2 bg-white dark:bg-black">
      <div className="flex justify-between items-center mb-2">
        <h1 className="text-lg font-bold dark:text-white">Edit Skill</h1>
        <Link
          to="/admin/skills"
